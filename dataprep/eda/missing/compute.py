...
def missing_impact(df: dd.DataFrame, bins: int) -> Intermediate:
    ...
    tasks = (
        ...
        missing_heatmap(nulldf, nullity, null_perc, cols),
    )
...
def missing_spectrum(data: da.Array, cols: np.ndarray, bins: int) -> dd.DataFrame:
    """
    ...
    if sep != nrows:
        ...
        spectrum_missing_percs = np.concatenate(
...
def missing_heatmap(
    nulldf: dd.DataFrame, nullity: da.Array, null_perc: da.Array, cols: np.ndarray
